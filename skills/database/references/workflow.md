...
The trigger function `public.set_updated_at()` is scaffolded by the CLI in `supabase/schemas/public/functions/set_updated_at.sql` — the agent doesn't need to create it.
