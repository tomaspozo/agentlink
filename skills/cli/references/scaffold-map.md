...
### UI building blocks
- `components/ui/` — shadcn primitives (button, dialog, dropdown-menu, table,
  badge, card, input, label, switch, tooltip, alert-dialog, skeleton).
- App components: `topbar`, `user-menu`, `workspace-menu`, `page-shell`,
